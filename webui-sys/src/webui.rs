...
pub const NoBrowser: webui_browser = 0;
pub const AnyBrowser: webui_browser = 1;
pub const Chrome: webui_browser = 2;
pub const Firefox: webui_browser = 3;
pub const Edge: webui_browser = 4;
pub const Safari: webui_browser = 5;
pub const Chromium: webui_browser = 6;
pub const Opera: webui_browser = 7;
pub const Brave: webui_browser = 8;
pub const Vivaldi: webui_browser = 9;
pub const Epic: webui_browser = 10;
pub const Yandex: webui_browser = 11;
pub const ChromiumBased: webui_browser = 12;
pub const Webview: webui_browser = 13;
pub type webui_browser = ::std::os::raw::c_int;
pub const None: webui_runtime = 0;
pub const Deno: webui_runtime = 1;
pub const NodeJS: webui_runtime = 2;
pub const Bun: webui_runtime = 3;
pub type webui_runtime = ::std::os::raw::c_int;
pub const WEBUI_EVENT_DISCONNECTED: webui_event = 0;
pub const WEBUI_EVENT_CONNECTED: webui_event = 1;
pub const WEBUI_EVENT_MOUSE_CLICK: webui_event = 2;
pub const WEBUI_EVENT_NAVIGATION: webui_event = 3;
pub const WEBUI_EVENT_CALLBACK: webui_event = 4;
pub type webui_event = ::std::os::raw::c_int;
pub const show_wait_connection: webui_config = 0;
pub const ui_event_blocking: webui_config = 1;
pub const folder_monitor: webui_config = 2;
pub const multi_client: webui_config = 3;
pub const use_cookies: webui_config = 4;
pub const asynchronous_response: webui_config = 5;
pub type webui_config = ::std::os::raw::c_int;
#[repr(C)]
...
pub const WEBUI_LOGGER_LEVEL_DEBUG: webui_logger_level = 0;
pub const WEBUI_LOGGER_LEVEL_INFO: webui_logger_level = 1;
pub const WEBUI_LOGGER_LEVEL_ERROR: webui_logger_level = 2;
pub type webui_logger_level = ::std::os::raw::c_int;
unsafe extern "C" {

...
extern "C" {
    #[doc = " @brief Set the maximum time in seconds to wait for the window to connect. This effect `show()` and `wait()`.\n\n @param second The timeout in seconds\n\n @example webui_set_timeout(30);"]
